...
\usepackage{titlesec}
%\titleformat{\section}[block]{\sc \Large}{\thesection}{1ex}{}
%\titleformat{\subsection}[block]{\normalfont\normalsize}{\thesubsection}{1ex}{}
%\titleformat{\subsubsection}[block]{\normalfont\normalsize}{\thesubsubsection}{1ex}{}
\renewcommand{\rmdefault}{ftm}
%\renewcommand{\ESKDtitleFontII}{\normalfont \normalsize}
...
\ESKDcompany{Государственное общеобразовательное учреждение\\
	...
	\mbox{Факультет}~\mbox{«Компьютерные}~\mbox{технологии},~\mbox{управление}~и~\mbox{радиоэлектроника}~(ПС)»
	}
...
\ESKDtitleDesignedBy{Студент группы КТУР-100}{Осипов И.О.}
